 ...
 *
 * Compile: gcc -O2 -o kairos kairos.c -lsqlite3 -lpthread -lm
 * With BLAS: gcc -O2 -DUSE_BLAS -o kairos kairos.c -lsqlite3 -lpthread -lm -lopenblas
 * macOS:     gcc -O2 -DUSE_BLAS -o kairos kairos.c -lsqlite3 -lpthread -lm -framework Accelerate
 *
